...
2. 按 [CONSOLE-SPEC-COMPLIANCE-BATCHES.md](./frontends/console/docs/CONSOLE-SPEC-COMPLIANCE-BATCHES.md) **SCB 顺序**改页面
3. Arco 组件 + Arco Token + Tailwind 布局；`npm run verify`
