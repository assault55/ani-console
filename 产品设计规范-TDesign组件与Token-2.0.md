# 产品设计规范 · TDesign 组件与 Token 2.0

> **⚠️ 已废止（2026-06-25）**  
> 本文档为 2.0 迁移前的 **TDesign** 草案，**不再作为设计或实现依据**。  
> 请改用：  
> - [UI规范-2.0.md](./UI规范-2.0.md)  
> - [产品设计规范-Arco组件与Token-2.0.md](./产品设计规范-Arco组件与Token-2.0.md)  
> - [产品设计规范-样式与Tailwind边界-2.0.md](./产品设计规范-样式与Tailwind边界-2.0.md)（含 Tailwind 废止说明）

---

# ~~产品设计规范 · TDesign 组件与 Token 2.0~~（历史归档）
...
- TDesign React 组件总览：https://tdesign.tencent.com/react/overview
