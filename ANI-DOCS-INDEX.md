...
| 产品/UI 设计规范（**已冻结 2026-06-25**） | [DESIGN-SPEC-FREEZE.md](./DESIGN-SPEC-FREEZE.md)、`UI规范-2.0.md`、`产品设计规范-*-2.0.md` | 只读真来源；禁止改正文 |
| Console 规范落地批次 | [frontends/console/docs/CONSOLE-SPEC-COMPLIANCE-BATCHES.md](./frontends/console/docs/CONSOLE-SPEC-COMPLIANCE-BATCHES.md) | SCB-01～12 顺序改造 |
| Console 任务与功能 Sprint | [frontends/console/docs/CONSOLE-TASK-PLAN.md](./frontends/console/docs/CONSOLE-TASK-PLAN.md) | P18+ 与 SCB 进度 |
